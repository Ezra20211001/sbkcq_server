...
struct tagBuffProto
{
	...
	DWORD				dwBeModSkillID;				// 影响该buff的技能id
...
struct tagBuffProtoClient : public tagBuffProto
{
    ...
    TCHAR				szInstantEffectMod[X_LONG_NAME];	// 瞬时特效编号
	TCHAR				szInstantEffectTag[X_LONG_NAME];	// 瞬时特效挂点
};
