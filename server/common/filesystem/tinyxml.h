...
*/
class FILE_API XmlNode : public XmlBase
{
	friend class XmlDocument;
	friend class XmlElement;
...
*/
class FILE_API XmlAttribute : public XmlBase
{
...
*/
class FILE_API  XmlAttributeSet
{
public:
	XmlAttributeSet();
	~XmlAttributeSet();
...
*/
class FILE_API XmlElement : public XmlNode
{
public:
...
/**	An XML comment.
*/
class FILE_API XmlComment : public XmlNode
{
public:
...
*/
class FILE_API XmlText : public XmlNode
{
	friend class XmlElement;
public:
...
*/
class FILE_API XmlDeclaration : public XmlNode
{
public:
...
*/
class FILE_API XmlUnknown : public XmlNode
{
public:
...
*/
class FILE_API XmlDocument : public XmlNode
{
public:
	...
	bool LoadFile(file_system* p_vfs, LPCTSTR szFilename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	...
	*/
	...
	bool LoadFile(file_system* p_vfs, tstring& strFilename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
		return LoadFile(p_vfs, strFilename.c_str(), encoding );
	}
...
/** Print to memory functionality. The XmlPrinter is useful when you need to:
	...
	@endverbatim
*/
class FILE_API XmlPrinter : public XmlVisitor
{
public:
