...
// 产量变更
struct NET_SIS_monster_plant_yield_change : public tag_net_message
{
	NET_SIS_monster_plant_yield_change()
	{
		ZeroMemory(this, sizeof(*this));
		dw_message_id = message_id_crc("NET_SIS_monster_plant_yield_change");
		dw_size = sizeof(NET_SIS_monster_plant_yield_change);
	}
	DWORD			dw_id;
	DWORD			dw_yield;
};
...
// 跟随宠物变更
struct NET_SIS_follow_creature_change : public tag_net_message
{
	NET_SIS_follow_creature_change()
	{
		ZeroMemory(this, sizeof(*this));
		dw_message_id = message_id_crc("NET_SIS_follow_creature_change");
		dw_size = sizeof(NET_SIS_follow_creature_change);
	}
	DWORD	n64ID;
};
