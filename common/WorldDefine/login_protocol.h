...
//! 账号注册
struct NET_C2L_regist_account : public tag_net_message
{
	NET_C2L_regist_account()
	{
		ZeroMemory(this, sizeof(*this));
		dw_message_id = message_id_crc("NET_C2L_regist_account");
		dw_size = sizeof(NET_C2L_regist_account);
	}
...
struct NET_L2C_proof_result : public tag_net_message
{
	...
	BYTE	special_account;
};

//! 角色认证消息
struct NET_C2L_proof_third : public tag_net_message
{
	NET_C2L_proof_third()
	{
		ZeroMemory(this, sizeof(*this));
		dw_message_id = message_id_crc("NET_C2L_proof_third");
		dw_size = sizeof(*this);
	}
	CHAR	szGUID[X_SHORT_NAME];			// GUID
